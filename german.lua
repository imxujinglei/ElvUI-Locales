...
L['Color of the actionbutton when out of power (Mana, Rage, Focus, Holy Power).'] = 'Farbe der Aktionstasten wenn man keine Kraft mehr hat (Mana, Wut, Fokus, Heilige Kraft).'
L['Color of the actionbutton when out of range.'] = 'Farbe der Aktionstasten wenn das Ziel Außer Reichweite ist.'
...
--Bags
L['Adjust the width of the bag frame.'] = 'Passe die Breite des Taschen Fensters an.'
L['Adjust the width of the bank frame.'] = 'Passe die Breite der Bank Fenster an.'
L['Align the width of the bag frame to fit inside the chat box.'] = 'Passt die Breite der Taschen Fenster an damit diese innerhalb der Chat Fenster passen.'
L['Align To Chat'] = 'Ausrichten zum Chat'
...
L['Currency Format'] = 'Währungs Format'
...
L['Hold Control + Right Click:'] = 'Halte Kontroll + Rechts Klick:'
L['Hold Shift + Drag:'] = 'Halte Shift + Bewegen:'
...
L['Panel Width (Bags)'] = 'Leisten Breite (Taschen)'
L['Panel Width (Bank)'] = 'Leisten Breite (Bank)'
L["Purchase"] = "Kaufen"
...
L['Sort Inverted'] = 'Sortieren invertiert'
L["Sort Special"] = "Sortiere Spezial"
L['Stack Bags to Bank'] = 'Staple Taschen zur Bank'
L['Stack Bank to Bags'] = 'Staple Bank zur Tasche'
...
L['The display format of the currency icons that get displayed below the main bag. (You have to be watching a currency for this to display)'] = 'Das Anzeige Format für die Währungs Symbole die unter der Haupttasche angezeigt werden. (Du musst eine Währung beobachten um diese angezeigt zu bekommen)'
...
L['The size of the individual buttons on the bag frame.'] = 'Die Größe der einzelnen Tasten auf dem Taschen Fenster.'
L['The size of the individual buttons on the bank frame.'] = 'Die Größe der einzelnen Tasten auf dem Bank Fenster.'
...
L['Filter Consolidated'] = 'Filter zusammengesetzt'
L['Index'] = 'Index'
...
L['Only show consolidated icons on the consolidated bar that your class/spec is interested in. This is useful for raid leading.'] = 'Zeige nur zusammengesetzte Symbole auf der zusammengesetzten Leiste die deine Klasse/Spezialisierung interessieren. Das ist hilfreich für Schlachtzugs Leitung.'
...
L['Attempt to lock the left and right chat frame positions. Disabling this option will allow you to move the main chat frame anywhere you wish.'] = 'Versuch um die rechte und linkte Chatfenster Position zu verschließen. Deaktiviere diese Option um das Hauptchatfenster nach belieben zu verschieben.'
L['Below Chat'] = 'Unter dem Chat'
L["BN:"] = "BN:"
L['Chat EditBox Position'] = 'Chat Eingabebox Position'
...
L['Fade the chat text when there is no activity.'] = 'Lasse den Chat Text Verblassen wenn keine Aktivität besteht.'
...
L['Lock Positions'] = 'Positionen verschließen'
L['Log the main chat frames history. So when you reloadui or log in and out you see the history from your last session.'] = 'Sichert den Chat Verlauf der Haupt Chat Fenster. Wenn du dein UI neulädst oder einloggst siehst du deinen Chat Verlauf der letzten Sitzung.'
...
L["PG"] = "PG"
L["PL"] = "PL"
L['Position of the Chat EditBox, if datatexts are disabled this will be forced to be above chat.'] = 'Position der Chat Eingabebox, wenn die Infotexte deakiviert sind wird es über dem Chat angebracht.'
...
L["Shorten the channel names in chat."] = "Kürze Kanal Namen im Chat."
...
L['Tab Panel'] = Tab Leiste;
L["Toggle showing of the left and right chat panels."] = "Aktiviere den Hintergrund des Linken und Rechten Chatfensters"
L['Toggle the chat tab panel backdrop.'] = Aktiviere den Hintergrund der oberen Tab Leisten der Chatfenster;
L['Trade'] = 'Tausch'
...
L['The Pixel Perfect option will change the overall apperance of your UI. Using Pixel Perfect is a slight performance increase over the traditional layout.'] = Die Pixel Perfekt Option wird das allgemeine Erscheinungsbild verändern. Das Verwenden von Pixel Perfekt benötigt etwas mehr Performance als das standart Layout;
...
L["You have changed the pixel perfect option. You will have to complete the installation process to remove any graphical bugs."] = "Du hast die pixel perfekt option geändert. Du solltest nun den installations Prozess beenden um Grafische Fehler zu entfernen."
...
L["Chest"] = "Brust"
L['Datatext Panel (Left)'] = 'Infotext Leiste (Links)'
L['Datatext Panel (Right)'] = 'Infotext Leiste (Rechts)'
...
L["World Boss(s)"] = Welt Boss(e);
L["Wrist"] = "Handgelenke"

--DebugTools
L["%s: %s tried to call the protected function '%s'."] = "%s: %s versucht die geschützte Funktion aufrufen '%s'."
L["INCOMPATIBLE_ADDON"] = "Das Addon %s ist nicht kompatibel mit dem ElvUI's %s modul. bitte wähle entweder das Addon oder deaktiviere das ElvUI Modul."
...
L['Display emotion icons in chat.'] = 'Zeige Emotions Symbole im Chat.'
...
L["Enable/Disable the loot roll frame."] = "Aktiviere/Deaktiviere das Beute Würfel Fenster."
...
L["Display your personal debuffs over the nameplate."] = "Zeige deine eigenen Schwächungszauber über den Namensplaketten."
...
L['Transmogrify Frame'] = 'Transmogrifikations Fenster'
...
L['Do you swear not to post in technical support about something not working without first disabling the addon/module combination first?'] = 'Du schwörst das du keinen Beitrag im Technischen Support posten wirst ohne vorher die Addon/Modul kombination zu deaktivieren?'
...
L["Count"] = "Zähler"
L["Cursor"] = "Zeiger"
L['Display guild ranks if a unit is guilded.'] = 'Zeige Gilden Ränge von Einheiten die in einer Gilde sind.'
L['Display how many of a certain item you have in your possession.'] = 'Zeige wieviele von den ausgewählten Items sich in deinem Besitz befinden.'
L['Display player titles.'] = 'Zeige Spieler Titel.'
L['Display the players talent spec in the tooltip, this may not immediately update when mousing over a unit.'] = 'Zeige die Talent Spezialisierung des Spielers in dem Tooltip, das wird möglicherweise nicht sofort aktualisiert wenn man mit der Maus über eine Einheit zieht.'
L['Display the spell or item ID when mousing over a spell or item tooltip.'] = 'Zeige die Zauber oder Item ID wenn du mit der Maus über einen Zauber oder Item ziehst.'
L["Don't display the tooltip when mousing over a unitframe."] = "Zeige keinen Tooltip wenn man über ein Einheitenfenster zieht."
L['Guild Ranks'] = 'Gilden Ränge'
L["Hide tooltip while in combat."] = "Verstecke den Tooltip während des Kampfes."
L['Item Count'] = 'Item Zähler'
...
L["Smart"] = "Intelligent";
L['Spell/Item IDs'] = 'Zauber/Item IDs'
L['Talent Spec'] = 'Talent Spezialisierung'
...
L['Allow Dispellable Auras'] = 'Erlaube Entzauberbare Auren'
L["Allow Personal Auras"] = "Erlaube Persönliche Auren"
L["Allow Whitelisted Auras"] = "Erlaube Weiße-Listen Auren"
...
L['Color aurabar debuffs by type.'] = 'Färbe Aurenleisten Schwächungszauber nach Typ.'
...
L["Icon"] = "Symbol"
L['If not set to 0 then override the size of the aura icon to this.'] = 'Wenn es nicht auf 0 gesetzt wird überschreibt es die größe des Auren Symbol um diese.'
L['If the unit is an enemy then this filter will be checked, otherwise it will be ignored.'] = 'Ist die Einheit ein gegnerisches Ziel wird dieser Filter geprüft, andersfalls wird es ignoriert.'
L['If the unit is friendly then this filter will be checked, otherwise it will be ignored.'] = 'Ist die Einheit ein freundliches Ziel wird dieser Filter geprüft, andersfalls wird es ignoriert.'
...
L['Select the display method of the portrait.'] = 'Wähle das Anzeige Verfahren für das Portrait.'
...
L["Size of the indicator icon."] = "Größe des Anzeige Symbole."
...
L['Text'] = Text;
L['Textured Icon'] = Reliefiertes Icon;
...
L['This filter is used for both aura bars and aura icons no matter what. Its purpose is to block out specific spellids from being shown. For example a paladin can have two sacred shield buffs at once, we block out the short one.'] = 'Dieser Gilter wird für beides benutzt Auren Leisten und Auren Symbole egal was. Sein Zweck besteht darin spezifische Zauber IDs zu blockieren bevor diese angezeigt werden. Ein Beispiel für einen Paladin ist das du zwei Geheiligter Schild Stärkungszauber aufeinmal hast, wir blockieren den kurzen.'
L["Ticks"] = "Ticks"
