...
L['Only show consolidated icons on the consolidated bar that your class/spec is interested in. This is useful for raid leading.'] = "Mostrar solamente los iconos consolidados en la barra que interesen a tu clase y/o especialización. Esto es útil para el liderazgo de bandas.";
...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to how they were pre-v4."] = "Selecciona el sistema de auras que quieres usar en los marcos de unidad de ElvUI. El sistema integrado utiliza una combinación de barras de aura e iconos de aura. El sistema de iconos sólo mostrará iconos, las auras no serán usadas. El sistema clásico configurará tus auras a como eran antes de la versión 4."
...
L['If you need to reset the gold datatext type /resetgold.'] = "Si necesitas borrar el texto de datos del oro escribe /resetgold.";
...
L['Allow Dispellable Auras'] = "Permitir Auras que se puedan Disipar";
