...
L['Lock Positions'] = "Retén la posisión.";
...
L["Chest"] = "Pecho"
L['Datatext Panel (Left)'] = "Panel (Izquierdo) Datos de texto.";
L['Datatext Panel (Right)'] = "Panel (Derecho) Datos de texto.";
...
L['Display data panels below the chat, used for datatexts.'] = "Mostrar los paneles de datos debajo de el chat, usado para datos de texto.";
