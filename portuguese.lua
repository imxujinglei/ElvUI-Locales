...
L["Number of columns (width) of bags. Set it to 0 to match the width of the chat panels."] = "Número de colunas (comprimento) das Bolsas. Definir 0 para corresponder com o comprimento dos painéis de conversação";
L["Number of columns (width) of the bank. Set it to 0 to match the width of the chat panels."] = "Número de colunas (comprimento) do Banco. Definir 0 para corresponder com o comprimento dos painés de conversação";
L["Purchase"] = "Comprar"
...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to how they were pre-v4."] = "Seleccione qual o sistema de auras que deseja usar com os quadros de unidades da ElvUI. O sistema integrado utiliza ambas as barras de auras e os ícones de auras. O sistema de Apenas Ícones irá exibir apenas os ícones sem que as barras de auras sejam usadas. O sistema Clássico irá configurar as suas auras como estavam antes da v4."
...
L["Main border color of the UI."] = "Cor básica para bordas da interface.";
L["Media"] = "Mídia";
...
L["When in a raid group display if anyone in your raid is targetting the current tooltip unit."] = "Exibe se alguém em sua raide tem como alvo a unidade da tooltip.";
...
L['The focus unit can be set by typing /focus when you are targetting the unit you want to focus. It is recommended you make a macro to do this.'] = "A unidade de Foco pode ser definida escrevendo /focus quando voce tem no alvo a unidade que quer tal. É recomendado que faça uma macro para este efeito.";
...
L['Allow displaying of auras that can be dispelled by me.'] = "Permitir a exibição de auras que são dissipáveis por mim.";
...
L["Color the icon to their set color in the filters section, otherwise use the icon texture."] = "Colorir o ícone com a cor definida na seção de filtros, caso contrário usar a textura do ícone.";
...
L["Fill"] = "Preencher";
L["Filled"] = "Preenchido";
L['Filter Auras Not Dispellable By Me'] = "Filtrar Auras não dissipáveis por mim";
L['Filter Auras with No Duration'] = "Filtrar Auras sem duração";
L["Filter Non-Personal Auras"] = "Filtrar Auras não pessoais";
L['Filter Raid Buffs'] = "Filtrar Bônus de Raide";
...
L["Health"] = "Vida";
L["Height"] = "Altura";
L['Hold shift + right click to blacklist this aura.'] = "Manter shift pressionado + clique direito para adicionar esta aura à lista negra.";
...
L['If set then if the aura is found on the blacklist filter it will not display. Note: You can change between only doing this on friendly or enemy units.'] = "Se definido e se a aura for encontrada no filtro da lista negra não será exibida. Nota: Você pode escolher entre fazer isto só para unidades amigáveis ou unidades inimigas.";
L['If set then if the aura is found on the whitelist filter it will display. Note: You can change between only doing this on friendly or enemy units.'] = "Se definido e se a aura for encontrada no filtro da lista branca será exibida. Nota: Você pode escolher entre fazer isto só para unidades amigáveis ou unidades inimigas.";
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "Se definido, apenas auras que pertençam a si próprio e auras que passem o(s) filtro(s) definido(s) serão mostradas. Nota: Você pode escolher entre só fazer isto em unidades amigáveis ou unidades inimigas.";
...
L['Set the type of auras to show when a unit is friendly.'] = "Define o tipo de auras a serem mostradas quando a unidade e amigável.";
...
L["Up"] = "Para cima";
L['Use Blacklist Filter'] = "Usar Filtro Lista Negra";
...
L['Use Whitelist Filter'] = "Usar Filtro Lista Branca";
