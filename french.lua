...
--TEMP
L['Portraits are temporarily forced to 2d for non directx 11 users.'] = "Les portraits sont activés en 2D pour les utilisateurs n'ayant pas DirectX11";
...
L['Only show consolidated icons on the consolidated bar that your class/spec is interested in. This is useful for raid leading.'] = "Montre seulement les icones consolidées sur la barre de sort consolidée tels que votre classe/Spec.Tres utile pour la gestion d'un raid"
...
L["Attempt to create URL links inside the chat."] = "tentative pour creer un lien URL dans les fenêtres de discussion."
L["BG"] = "BG"
L["BGL"] = "BGL"
L["BN:"] = "BN:"
...
L["Font Outline"] = "Contours sortant de la police" --Also used in UnitFrames section
L["Font"] = "Police"
L["G"] = "G"
...
L['Log the main chat frames history. So when you reloadui or log in and out you see the history from your last session.'] = "Active la fenetre principale de l historique de la discussion.Ainsi quand vous rechargez l interface ou connection /deconnection vous voyez l historique de la derniere cession";
...
L["PG"] = "PG"
L["PL"] = "CdG"
L["Prevent the same messages from displaying in chat more than once within this set amount of seconds, set to zero to disable."] = "Empeche l'affichage du meme message plus d'une fois dans la fenêtre de discussion, s'il est répété de plusieurs fois.reglage a zero pour le desactiver"
L["R"] = "R"
...
L["Set the font outline."] = "Configure le contour sortant de la police d'écriture." --Also used in UnitFrames section
...
L["Tab Font Outline"] = "Contour de la police d'écriture sortante des onglets";
...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to how they were pre-v4."] = "Sélectionnez le système d'aura que vous souhaitez utiliser avec les cadres d'unités d'ElvUI. Le système intégré utilise à la fois les barres d'aura et les icônes alors qu'Icônes seulement affichera uniquement les icônes et non les barres d'auras. Le système classique configurera vos auras comme elles étaient avant la version 4 d'ElvUI."
...
L["Version"] = "Version"
L["You are now finished with the installation process. Bonus Hint: If you wish to access blizzard micro menu, middle click on the minimap. If you don't have a middle click button then hold down shift and right click the minimap. If you are in need of technical support please visit us at www.tukui.org."] = "Vous avez maintenant terminé le processus d'installation.Astuce: Si vous souhaitez acceder au micro menu Blizzard,sur la minimap cliquez sur le bouton du  milieu de votre souris . Si vous n avez pas de bouton sur la souris maintenir la touche MAJ enfoncée et  cliquez droit sur la minimap. Si vous avez besoin d'un support technique, merci de vous rendre sur www.tukui.org"
...
L['Mitigation By Level: '] = "Reduction par niveau: "
...
L["The font that appears on the text above players heads. |cffFF0000WARNING: This requires a game restart or re-log for this change to take effect.|r"] = Police qui apparait sur le texte au desus de la tete des joueurs. |cffFF0000ATTENTION: requiert un redemarrage ou re-connection du  jeu pour que les changements fonctionnent.|r"]
...
L["Castbar Height"] = "Hauteur de la barre de la barre d'incantation"
...
L["Help Frame"] = "Fenetre d'Assistance clientèle"
...
L["Petition Frame"] = "Fenetre de Charte"
L["PvP Frames"] = "Fenetre JcJ"
L["Quest Frames"] = "Fenetre de Quêtes"
L["Raid Frame"] = "Fenetre de Raid"
...
L["Talent Frame"] = "Fenetre des talents"
...
L['Transmogrify Frame'] = "Fenetre de Transmogrification";
...
L['Display the players talent spec in the tooltip, this may not immediately update when mousing over a unit.'] = "Affiche la specialisation des talents du joueur dans l'info-bulle,cela ne peut pas se mettre a jour au survol d'une unité";
...
L["Smart"] = "Intelligent"
L['Talent Spec'] = "specialisation des talents";
L["Targeted By:"] = "Ciblé par: "
L["Tooltip"] = "Info-bulle"
L["TOOLTIP_DESC"] = "Configuration des Info-bulles."
L["UF Hide"] = "Portait d'unité caché"
L["When in a raid group display if anyone in your raid is targetting the current tooltip unit."] = "Dans un groupe de raid ,affiche l info bulle d une personne ciblée par une autre."
L["Who's targetting who?"] = "Qui cible qui ?"
...
L['If you need to reset the gold datatext type /resetgold.'] = "Si vous souhaitez réinitialiser le texte d'information des pièces d'or, tapez /resetgold."
...
L['Allow displaying of auras that can be dispelled by me.'] = "Autoriser l'affichage de l'aura qui sera dissipé par moi;
...
L['Click Through'] = "Click a travers";
...
L["Display the target of the cast on the castbar."] = "Affiche l'incantation sur la barre de cast de la cible."
...
L["Fill"] = "Remplissage"
L["Filled"] = "Rempli"
L['Filter Auras Not Dispellable By Me'] = "filtre des Auras non dissipé par le joueur"
L['Filter Auras with No Duration'] = "filtre des Auras sans durée"
L["Filter Non-Personal Auras"] = "filtres des Auras indirect"
L['Filter Raid Buffs'] = "filtre d'amelioration du  raid"
...
L["Health"] = "Vie"
L["Height"] = "Hauteur"
L['Hold shift + right click to blacklist this aura.'] = "Maintenir MAJ + clic droit pour mettre en liste noire cette aura."
...
L['If set then if the aura is found on the blacklist filter it will not display. Note: You can change between only doing this on friendly or enemy units.'] = "Si l'aura est  deja definie dans la liste noire, elle ne sera pas affichée. Remarque: Vous pouvez changer entre les unités amies ou ennemies."
L['If set then if the aura is found on the whitelist filter it will display. Note: You can change between only doing this on friendly or enemy units.'] = "Si l'aura est  deja definie dans la liste blanche, elle sera affichée. Remarque: Vous pouvez changer entre les unités amies ou ennemies."
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "S'il est  definie,seuls les auras vous appartenant ,en plus de toute auras, peuvent etre indiqué dans le passage du  filtre. Remarque: Vous pouvez le changer entre,et seulement le faire,avec les unités amicales ou hostiles";
L['Ignore mouse events.'] = "ignorer les evenements de la souris"
...
L["Up"] = "Haut"
L['Use Blacklist Filter'] = "Utiliser le filtre de la liste noire"
...
L['Use Whitelist Filter'] = "Utiliser le filtre de la liste blanche"
