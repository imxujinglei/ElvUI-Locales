...
L['Display the players talent spec in the tooltip, this may not immediately update when mousing over a unit.'] = "Affiche la specialisation des talents du joueur dans l'info-bulle, cela ne peut pas se mettre à jour au survol d'une unité";
...
L["Display the target of the cast on the castbar."] = "Affiche l'incantation sur la barre d'incantation de la cible."
...
L["Filter Non-Personal Auras"] = "Filtre des Auras indirect"
L['Filter Raid Buffs'] = "Filtre d'amélioration du raid"
...
L['If set then if the aura is found on the blacklist filter it will not display. Note: You can change between only doing this on friendly or enemy units.'] = "Si l'aura est déjà definie dans la liste noire, elle ne sera pas affichée. Remarque: Vous pouvez changer entre les unités amies ou ennemies."
L['If set then if the aura is found on the whitelist filter it will display. Note: You can change between only doing this on friendly or enemy units.'] = "Si l'aura est déjà definie dans la liste blanche, elle sera affichée. Remarque: Vous pouvez changer entre les unités amies ou ennemies."
