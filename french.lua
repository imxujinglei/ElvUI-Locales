...
L['Already Running.. Bailing Out!'] = "Déjà cours d'exécution..."; --Need review
...
L['Allow Dispellable Auras'] = "Autoriser les Auras dissipable."
L["Allow Personal Auras"] = "Autoriser les Auras personnelles"
L["Allow Whitelisted Auras"] = "Autoriser les Auras sur liste Blanche"
...
L['If the unit is an enemy then this filter will be checked, otherwise it will be ignored.'] = "Si l'unité est un ennemi alors ce filtre sera coché, sinon il sera ignoré."
L['If the unit is friendly then this filter will be checked, otherwise it will be ignored.'] = "Si l'unité est amie alors ce filtre sera coché, sinon il sera ignoré."
