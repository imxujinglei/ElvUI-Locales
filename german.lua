...
L['Allow displaying of auras that can be dispelled by me.'] = 'Zeige nur Auren die du selbst Entzaubern kannst.'
...
L["Fill"] = "Füllen"
L["Filled"] = "Gefüllt"
L['Filter Auras Not Dispellable By Me'] = 'Filtere Auren die nicht Entzauberbar von mir sind'
L['Filter Auras with No Duration'] = 'Filtere Auren mit keiner Dauer'
L["Filter Non-Personal Auras"] = "Filter Nicht-Persönliche Auren"
L['Filter Raid Buffs'] = 'Filtere Schlachtzugs Stärkungszauber'
...
L['If set then if the aura is found on the blacklist filter it will not display. Note: You can change between only doing this on friendly or enemy units.'] = 'Wenn ein  im Schwarzen-Listen Filter ist wird es nicht angezeigt. Notiz: Du kannst das nur ändern zwischen freundliche und feindliche Einheiten.'
L['If set then if the aura is found on the whitelist filter it will display. Note: You can change between only doing this on friendly or enemy units.'] = 'Wenn ein Stärkungs/Schwächungszauber im Weißen-Listen Filter ist wird es nicht angezeigt. Notiz: Du kannst das nur ändern zwischen freundliche und feindliche Einheiten.'
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "Wenn dies aktiv ist, werden nur deine eigenen Auren und jene, die dem eingestellten Filter(n) entsprechen, angezeigt."
...
L["Up"] = "Hinauf"
L['Use Blacklist Filter'] = 'Benutze Schwarze Liste Filter'
...
L['Use Whitelist Filter'] = 'Benutze Weiße Liste Filter'
