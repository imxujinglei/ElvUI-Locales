...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to how they were pre-v4."] = "Selecciona el sistema de auras que quieres usar en los marcos de unidad de ElvUI. El sistema integrado utiliza una combinación de barras de aura e iconos de aura. El sistema de iconos solo mostrará iconos, las auras no serán usadas. El sistema clásico configurará tus auras a como eran pre-v4."
...
L["LFG Frame"] = "Marco de Búsqueda de Grupo";
...
L["Misc Frames"] = "Marcos de Miscelánea";
...
L["Reforge Frame"] = "Marco de Reforge";
L["Skins"] = "Pieles";
L["SKINS_DESC"] = "Ajustar Opciones de Pieles"
...
L['Allow Dispellable Auras'] = "Permitir Auras Disipables";
L["Allow Personal Auras"] = "Permitir Auras Personales";
L["Allow Whitelisted Auras"] = "Permitir Auras en la Lista Blanca";
L["An X offset (in pixels) to be used when anchoring new frames."] = "Un desplazamiento X (en pixels) para ser usado cuando se fijan nuevos marcos.";
L["An Y offset (in pixels) to be used when anchoring new frames."] = "Un desplazamiento Y (en pixels) para ser usado cuando se fijan nuevos marcos.";
...
L["Block Blacklisted Auras"] = "Bloquear Auras en la Lista Negra";
...
L["Health"] = "Salud";
L["Height"] = "Altura";
L['Hold shift + right click to blacklist this aura.'] = "Mantener shift + botón derecho para añadir este aura a la lista negra.";
...
L['If the unit is friendly then this filter will be checked, otherwise it will be ignored.'] = "Este filtro solamente se comprobará si la unidad es amistosa, de lo contrario se ignorará";
L['If the unit is an enemy then this filter will be checked, otherwise it will be ignored.'] = "Este filtro solamente se comprobará si la unidad es enemiga, de lo contrario se ignorará";
...
L["Overlay"] = "Recubrir";
L["Override any custom visibility setting in certain situations, EX: Only show groups 1 and 2 inside a 10 man instance."] = "Sobrescribir cualquier opción de visibilidad en ciertas situaciones, Ej: Solo mostrar grupos 1 y 2 dentro de una mazmorra de banda de 10 personas.";
...
L['Player Frame Aura Bars'] = "Barra de Auras del Marco de Jugador";
...
L['Select the display method of the portrait.'] = "Selecciona el modo de muestra para los retratos";
...
'deficit' - muestra el varlor de déficit, no muestra nada si no hay déficit
