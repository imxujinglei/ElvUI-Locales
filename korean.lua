...
--Bags
L["Ascending"] = true;
L["Bag Columns"] = "가방 열" -- Needs review
L["Bag-Bar"] = true;
L["Bags"] = "가방"
L["BAGS_DESC"] = "ElvUI 위해 가방 설정을 조정합니다." -- Needs review
L["Bank Columns"] = "은행 열" -- Needs review
L["Bar Direction"] = true;
L["Bottom to Top"] = "상단 아래쪽으로 이동" -- Needs review
...
L["Number of columns (width) of bags. Set it to 0 to match the width of the chat panels."] = "가방을 열 수 (폭).채팅 패널의 너비와 일치하도록 0으로 설정합니다." -- Needs review
L["Number of columns (width) of the bank. Set it to 0 to match the width of the chat panels."] = "은행의 열 수 (폭).채팅 패널의 너비와 일치하도록 0으로 설정합니다." -- Needs review
L["Purchase"] = "구매"
...
L["Sort Orientation"] = "가방 정렬" -- Needs review
...
L["BG"] = "전장"
L["BGL"] = "전장 지휘관"
L["BN:"] = "BN:" -- Needs review
L["Chat"] = "대화창"
L["CHAT_DESC"] = "ElvUI의 대화창을 설정합니다."
L["Copy Text"] = "텍스트 복사" -- Needs review
...
L["Using the healer layout it is highly recommended you download the addon Clique to work side by side with ElvUI."] = "힐러 레이아웃을 사용중시군요. 그렇다면 Clique 애드온을 다운받아서 ElvUI와 함께 사용하는걸 매우 권장합니다." -- Needs review
L["Version"] = "버전"
...
L["Skin the blizzard chat bubbles."] = "말풍선 스킨  있습니다." -- Needs review
L["Tiny Map"] = true;
...
L["Rested:"] = "휴식 경험치:"
L['Right Chat'] = true;
L["Right Click:"] = "오른쪽 클릭하십시오 :" -- Needs review --layout\layout.lua
...
L["Save"] = "저장"
L["You have changed your UIScale, however you still have the AutoScale option enabled in ElvUI. Press accept if you would like to disable the Auto Scale option."] = "UI 배율이 변경되었지만 ElvUI의 자동크기 설정이 켜져있습니다. 자동크기 설정을 끄고 싶다면 '수락'을 누르세요." -- Needs review
...
L["Rest Icon"] = "아이콘 휴식" -- Needs review
