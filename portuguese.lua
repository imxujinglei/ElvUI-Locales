...
L["Enable/Disable the Bag-Bar."] = "Activar/Desactivar a Barra das Bolsas.";
...
L["Fade Threshold"] = "Limiar para Desaparecer";
...
L['Threshold before text changes red, goes into decimal form, and the icon will fade. Set to -1 to disable.'] = "Limiar antes do texto se tornar vermelho, mudar para forma décimal e o ícone desaparecer. Definir -1 para desativar.";
L['Time'] = "Tempo";
...
L['DND'] = "NP"
L['Fade Chat'] = "Esmaecer o bate-papo";
L['Fade the chat text when there is no activity.'] = "Esmaece o texto do bate-papo quando não há atividade.";
...
L['Filter Raid Buffs'] = "Filtrar Buufs de Raide";
...
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "Se definido, apenas auras que pertençam a si próprio e auras que passem o(s) filtro(s) definido(s) serão mostradas. Nota: Você pode escolher entre só fazer isto em unidades amigáveis ou unidades enimigas.";
