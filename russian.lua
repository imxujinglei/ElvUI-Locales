...
L["Already Running.."] = "Уже выполняется"
...
L["Button Size (Bag)"] = "Размер слотов банка"
L["Button Size (Bank)"] = "Размер слотов сумок"
...
L['Allow Dispellable Auras'] = "Разрешить развееваемые ауры"
L["Allow Personal Auras"] = "Разрешить личные ауры"
L["Allow Whitelisted Auras"] = "Разрешить ауры белого списка"
