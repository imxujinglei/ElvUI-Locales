...
L["Number of columns (width) of bags. Set it to 0 to match the width of the chat panels."] = "가방을 열 수 (폭).채팅 패널의 너비와 일치하도록 0으로 설정합니다."
L["Number of columns (width) of the bank. Set it to 0 to match the width of the chat panels."] = "은행의 열 수 (폭).채팅 패널의 너비와 일치하도록 0으로 설정합니다."
L["Purchase"] = "구매"
