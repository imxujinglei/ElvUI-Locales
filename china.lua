...
L["Buttons"] = "按钮数"
L['Change the alpha level of the frame.'] = "调整框架的不透明级别";
L['Color of the actionbutton when out of power (Mana, Rage, Focus, Holy Power).'] = "当能量值（法力值，怒气，集中值，圣能）不足时的动作条按钮颜色";
L['Color of the actionbutton when out of range.'] = "当超出距离时的动作条按钮颜色";
...
L['The button you must hold down in order to drag an ability to another action button.'] = "将一个动作提取到另一个按钮时必须按住的键";
...
L['Align the width of the bag frame to fit inside the chat box.'] = "将背包框架和聊天框对齐";
L['Align To Chat'] = "对齐聊天框架";
...
L["Descending"] = "降序";
L["Direction the bag sorting will use to allocate the items."] = "整理背包物品的排序方向";
L["Enable/Disable the all-in-one bag."] = "开/关整合背包。"
L["Enable/Disable the Bag-Bar."] = "开/关背包条";
L["goldabbrev"] = "|cffffd700g|r" --Also used in gold datatext
L['Hold Control + Right Click:'] = "按住 Ctrl + 右键：";
L['Hold Shift + Drag:'] = "按住 Shift + 拖动";
...
L["Set the size of your bag buttons."] = "设置背包条按钮大小";
L["silverabbrev"] = "|cffc7c7cfs|r" --Also used in gold datatext
L["Sort Bags"] = "背包整理"
L["Sort Direction"] = "排列方向"; --Also used in Buffs and Debuffs
L['Sort Inverted'] = "逆序整理";
L["Sort Special"] = "整理特殊背包"
L['Stack Bags to Bank'] = "堆叠到银行";
L['Stack Bank to Bags'] = "堆叠到背包";
L["Stack Items"] = "堆叠物品"
L["Stack Special"] = "堆叠特殊背包"
L['Temporary Move'] = "临时移动";
L["The direction that the bag frames be (Horizontal or Vertical)."] = "背包条框体方向（水平或垂直）";
L["The direction that the bag frames will grow from the anchor."] = "背包条对齐锚点方向";
...
L['The size of the individual buttons on the bag frame.'] = "背包框体各按钮的大小";
L['The size of the individual buttons on the bank frame.'] = "银行框体各按钮的大小";
L["The spacing between buttons."] = "两个按钮间的距离"
L['Toggle Bags'] = "切换背包";
L["Top to Bottom"] = "从上至下";
L["Vendor Grays"] = "出售灰色物品"
L["Vendored gray items for:"] = "已出售灰色物品:"
L["X Offset"] = "X轴偏移"
L["Y Offset"] = "Y轴偏移"
L['You must be at a bank.'] = "你必须以银行为目标";
...
L["Sticky Chat"] = true;
L["Tab Font Outline"] = "页签字体描边";
L["Tab Font Size"] = "页签字体大小";
L["Tab Font"] = "页签字体";
L['Tab Panel'] = "页签栏";
L["Toggle showing of the left and right chat panels."] = "切换左/右对话框显示与否."
L['Toggle the chat tab panel backdrop.'] = "切换聊天页签栏背景";
L['Trade'] = "交易";
L["URL Links"] = "网址连结"
...
L["Caster DPS"] = "法系输出"
L["Chat Set"] = "聊天设定"
L['Choose a theme layout you wish to use for your initial setup.'] = "选择一个初始的主题布局";
L['Classic'] = "经典";
...
L["Legs"] = "腿"
L["Local Time"] = "本地时间"
L['Location Text'] = "位置文本";
L["lvl"] = "等级"
L["Main Hand"] = "主手"
L["middle"] = "中"
L['Minimap Mouseover'] = "微缩地图鼠标悬停";
L['Minimap Panels'] = "微缩地图面板";
...
L['Display emotion icons in chat.'] = "在聊天框中显示表情图标";
...
L["Loot Roll"] = "掷骰"
L["Loot"] = "拾取"
L["Map Alpha While Moving"] = "移动时地图透明度";
L["Name Font"] = "名字字体";
...
L["Filter already exists!"] = "筛选器已经存在！";
...
L["Are you sure you want to delete all your gray items?"] = "确认要删除所有灰色物品？";
...
L["Count"] = "计数"
L["Cursor"] = "游标跟随"
L['Display guild ranks if a unit is guilded.'] = "如果该单位有工会就显示工会头衔";
L['Display how many of a certain item you have in your possession.'] = "显示该物品在你背包中有多少数量";
...
L['Raid Icon'] = "Raid 图标";
L['Raid-10 Frames'] = "10人Raid框架";
L['Raid-25 Frames'] = "25人Raid框架";
L['Raid-40 Frames'] = "40人Raid框架";
