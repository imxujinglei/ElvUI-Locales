...
L['Allow displaying of auras that can be dispelled by me.'] = "Permitir mostrar auras que pueda disipar";
...
L["Fill"] = "Llenar";
L["Filled"] = "Lleno";
L['Filter Auras Not Dispellable By Me'] = "Filtrar Auras No Disipables Por Mi";
L['Filter Auras with No Duration'] = "Filtrar Auras Sin Duración";
L["Filter Non-Personal Auras"] = "Filtrar Auras Ajenas";
L['Filter Raid Buffs'] = "Filtrar Beneficios de Banda";
...
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "Si se establece, solo se mostrarán las auras pertenecientes a ti mismo además de cualquier aura que pase los filtros. Nota: Puedes cambiar entre hacerlo solo en unidades amistosas o unidades enemigas.";
...
L["Up"] = "Arriba";
L['Use Blacklist Filter'] = "Usar el Filtro de Lista Negra";
...
L['Use Whitelist Filter'] = "Usar el Filtro de Lista Blanca";
