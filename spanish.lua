...
L['Already Running..'] = "Ya está en ejecución...";
...
L['The display format of the currency icons that get displayed below the main bag. (You have to be watching a currency for this to display)'] = "El formato de moneda de que muestra debajo de la bolsa principal (debes monitorear una divisa para que se muestre).";
