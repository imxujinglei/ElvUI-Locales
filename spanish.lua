...
L['Do you swear not to post in technical support about something not working without first disabling the addon/module combination first?'] = '¿Juras no "postear" en Soporte Técnico acerca de algo que no funciona sin antes deshabilitar la combinación addon/módulo primero?';
