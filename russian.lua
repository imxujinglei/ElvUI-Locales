...
--TEMP
L['Portraits are temporarily forced to 2d for non directx 11 users.'] = "Портреты временно установлены на 2D для пользователей без directx 11"
...
L['2D'] = true --Doesn't need translation
L['3D'] = true
...
L['Allow displaying of auras that are considered consolidated by Blizzard.'] = "Скрытие аур, которые считаются Blizzard объединенными."
L['Allow displaying of auras that can be dispelled by me.'] = "Отображение аур, которые можно снять данным персонажем"
L['Allow displaying of auras that do not have a duration.'] = "Скрытие аур, не имеющих времени действия."
...
L['Filter Auras Not Dispellable By Me'] = "Фильтр аур, снимаемых мной"
L['Filter Auras with No Duration'] = "Фильтр аур без длительности"
L["Filter Non-Personal Auras"] = "Фильтровать чужие ауры"
L['Filter Raid Buffs'] = "Фильтр рейдовых баффов"
...
L['If set then if the aura is found on the blacklist filter it will not display. Note: You can change between only doing this on friendly or enemy units.'] = 'При включении, если аура обнаружена в фильтре "Blacklist", она не будет показана. Примечание: Вы также можете назначить применение фильтрации только к дружественным или враждебным целям.';
L['If set then if the aura is found on the whitelist filter it will display. Note: You can change between only doing this on friendly or enemy units.'] = 'При включении, если аура обнаружена в фильтре "Whitelist", она будет показана. Примечание: Вы также можете назначить применение фильтрации только к дружественным или враждебным целям.';
L["If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units."] = "При включении из пропущенных фильтром(ами) аур будут показываться только наложенные Вами. Примечание: Вы также можете назначить применение фильтрации только к дружественным или враждебным целям."
...
L["Up"] = "Вверх"
L['Use Blacklist Filter'] = "Использовать черный список"
...
L['Use Whitelist Filter'] = "Использовать белый список"
